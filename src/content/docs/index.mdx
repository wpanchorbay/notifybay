...
hero:
  ...
  actions:
    - text: Get Started
      link: /notifybay-docs/getting-started/introduction/
      icon: right-arrow
      variant: primary
    - text: View on GitHub
...
<CardGrid>
  <Card title="Back-in-Stock (Waitlist)">
    ...
    <img src="/notifybay-docs/assets/screenshots/homepage-waitlist-btn.png" alt="Waitlist Button" data-lightbox="true" />
  ...
  <Card title="Price Drop (Wishlist)">
    ...
    <img src="/notifybay-docs/assets/screenshots/homepage-wishlist-btn.png" alt="Price Drop Button" data-lightbox="true" />
...
<CardGrid>
  <Card title="Potential Recovery" icon="add-document">
    ...
    <img src="/notifybay-docs/assets/screenshots/homepage-recovery-card.png" alt="Potential Recovery Card" data-lightbox="true" />
  </Card>
  <Card title="Demand Trends" icon="list-format">
    ...
    <img src="/notifybay-docs/assets/screenshots/homepage-analytics-chart.png" alt="Demand Trends Chart" data-lightbox="true" />
  </Card>
</CardGrid>
...
<CardGrid>
  <Card title="My Account Integration">
    ...
    <img src="/notifybay-docs/assets/screenshots/homepage-my-account-tab.png" alt="My Account Tabs" data-lightbox="true" />
  </Card>
  <Card title="Urgency (Hurry) Alerts">
    ...
    <img src="/notifybay-docs/assets/screenshots/homepage-email-snippet.png" alt="Hurry Alert Snippet" data-lightbox="true" />
  </Card>
</CardGrid>
...
<CardGrid stagger>
    ...
    <img src="/notifybay-docs/assets/screenshots/homepage-settings-toggle.png" alt="Compliance Toggle" data-lightbox="true" />
	</Card>
    ...
    <img src="/notifybay-docs/assets/screenshots/homepage-gutenberg-block.png" alt="Gutenberg Block Integration" data-lightbox="true" />
	</Card>
</CardGrid>
