...
![General Feature Selection](/notifybay-docs/assets/screenshots/settings-general-logic.png)
...
![Double Opt-In Section](/notifybay-docs/assets/screenshots/settings-compliance-optin.png)
...
![Backorder Behavior Dropdown](/notifybay-docs/assets/screenshots/settings-backorder-logic.png)
...
![Waitlist Styling Section](/notifybay-docs/assets/screenshots/settings-waitlist-styling.png)
...
![Social Proof Settings](/notifybay-docs/assets/screenshots/settings-fomo-logic.png)
...
![Wishlist Styling Section](/notifybay-docs/assets/screenshots/settings-wishlist-styling.png)
...
![Custom CSS Editor](/notifybay-docs/assets/screenshots/settings-css-editor.png)
