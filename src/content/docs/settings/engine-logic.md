...
![Fair Play Settings Section](/notifybay/assets/screenshots/engine-fair-play-group.png)
...
![Minimum Stock Threshold Field](/notifybay/assets/screenshots/engine-min-stock-threshold.png)
...
![Hurry Alert Automation Controls](/notifybay/assets/screenshots/engine-hurry-automation.png)
...
![Lead Expiry & Hygiene Settings](/notifybay/assets/screenshots/engine-expiry-logic.png)
...
![Sales Attribution Window Setting](/notifybay/assets/screenshots/engine-attribution-window.png)
...
![Owner Alert Toggle](/notifybay/assets/screenshots/engine-owner-alerts.png)

*   **Owner Alerts:** Enable this to receive a real-time email whenever a new shopper joins a waitlist or wishlist. 

> [!TIP]
> For busy stores, we recommend keeping this **OFF** to avoid inbox clutter and instead reviewing your [Dashboard Analytics](/notifybay/dashboard/analytics/) once a day.
